	...
	return (
		<div className="relative max-w-full overflow-x-hidden bg-linear-to-b from-0% from-card to-[50vh] to-background">
			...
			<div className="container relative z-20 pt-44 pb-12 text-center lg:pb-16">
				...
				<h1 className="mx-auto max-w-6xl text-balance font-bold text-5xl lg:text-6xl">
					Centralize toda a adminitração de seu escritório
				</h1>

				<p className="mx-auto mt-8 max-w-lg text-balance text-foreground/60 text-lg">
					A solução definitiva para organizar o fluxo de trabalho do seu escritório, sem precisar contratar uma equipe interna.
				</p>
